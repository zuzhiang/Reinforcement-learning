...
class DuelingDQN():
    ...
    def build_net(self):
        ...
        with tf.variable_scope("eval_net"):  # 估值网络
            ...
            self.V=tf.layers.dense(e1, 1, kernel_initializer=w_initializer,
                                          bias_initializer=b_initializer, name="value_function")
            self.A = tf.layers.dense(e1, self.n_actions, kernel_initializer=w_initializer,
                                     bias_initializer=b_initializer, name="advantage_function")
        ...
        with tf.variable_scope("target_net"):  # 目标网络
            t1 = tf.layers.dense(self.s_, 20, tf.nn.relu, kernel_initializer=w_initializer,
                                 bias_initializer=b_initializer, name="t1") # 第1层
            # 价值函数
            self.V = tf.layers.dense(t1, 1, kernel_initializer=w_initializer,
                                     bias_initializer=b_initializer, name="value_function")
            # 优势函数
            self.A = tf.layers.dense(t1, self.n_actions, kernel_initializer=w_initializer,
                                     bias_initializer=b_initializer, name="advantage_function")
            # Q(s,a)=V(s)+[A(s,a)-mean(A(s,a))]
